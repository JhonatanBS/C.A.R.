package com.car.appCar.interfaces

import com.car.appCar.domain.Driver
import com.car.appCar.domain.DriverRepository
import com.car.appCar.domain.PatchDriver
...
class DriverAPI(val driverRepository: DriverRepository) {
    ...
    fun fullUpdateDriver(@PathVariable("id") id: Long, @RequestBody driver: Driver): Driver {
        ...
        val copyDriver = foundDriver.copy(birthDate = driver.birthDate, name = driver.name)
